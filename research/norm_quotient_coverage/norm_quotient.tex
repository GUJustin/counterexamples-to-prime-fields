...
every affine challenge nearby, with a far direction, at that larger
margin over arbitrary fields and domains. Thus near-complete coverage
is not itself a new regime. The additional property here is the
structured construction with two individually far sources and exact
source and common agreement; no priority claim for that refinement
is made. The alphabet is an extension field, $p\ll J$, and the
