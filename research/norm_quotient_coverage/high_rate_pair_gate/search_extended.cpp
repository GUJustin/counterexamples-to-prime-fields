...
int main(int argc,char**argv){int limit=argc>1?atoi(argv[1]):65537;long long shapes=0,cosets=0,fullpass=0,deleted=0;int bestmissing=999999,bp=0,bL=0,bb=0;vector<int> hits;for(int p=3;p<=limit;p+=2)if(prime(p)){
