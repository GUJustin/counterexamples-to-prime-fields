...
exactly $A=2p$ such that, at threshold $T=\lfloor11p/5\rfloor$, the
...
$(T-A)/(T-3)$ tends to $1/11$, and the characteristic is
$p=\Theta(\sqrt n)>2$. The evaluation domain is a selected subset of
...
\[
 2p-2+\lceil p/4\rceil\ge\lfloor11p/5\rfloor=T
\]
matches. The planes $I_a+\eta I_a$ intersect pairwise only at zero.
...
\]
for $p>256$. Also $T>A$ and
$T^2\le121p^2/25<5p^2-1=2n$. This proves the stated comparisons.
\end{proof}
