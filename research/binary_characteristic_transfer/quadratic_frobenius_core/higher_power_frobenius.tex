...
over $\mathbb F_p$. The preceding bounds give $A(r_i)\le hp+h^2$,
...
$h^2=o(hp)$ and $(h+R)(p-1)\sim2hp$. The branch condition also holds.
...
$k=6$, and $T=593$. Its common agreement is $485$, each endpoint
has agreement at most $510$, and there are $921984$ singleton
