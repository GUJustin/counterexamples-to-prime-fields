...
sp=importlib.util.spec_from_file_location('base','independent_ramified_jacobian_verify.py');b=importlib.util.module_from_spec(sp);sp.loader.exec_module(b)
...
assert not any(flat), 'Hasse quadratic does not vanish on entire saved tangent basis'
