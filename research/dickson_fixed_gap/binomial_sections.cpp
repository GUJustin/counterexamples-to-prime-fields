...
int main(){
  ...
  for(int k: {8,11,16,23,32,47,64,97,128})for(int r=2;r<=80;++r){
    int p=2*r*k+1;if(!prime(p))continue;
    std::vector<int>sections={0,1,r/2,r-1};std::sort(sections.begin(),sections.end());sections.erase(std::unique(sections.begin(),sections.end()),sections.end());
