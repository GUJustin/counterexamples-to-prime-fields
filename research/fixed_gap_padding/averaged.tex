...
\input{research/prime_field_tightness/list_amplification.tex}
...
\input{research/paired_domain_warp/paired.tex}

\input{research/cubic_domain_warp/cubic_warp.tex}

\subsection{Elementary padded-interval refinements}

The following bounds use the original interval core directly. They give
additional finite examples and tradeoffs without the cubic deformation.
