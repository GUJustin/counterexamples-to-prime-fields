...
for the Eq60 standard derivative-capped, total-degree-capped support and
Eq63 graded row test, the squarefree list and regular-MCA ledgers necessarily
...
the historical cubic/fifth-power claim. Arbitrary supports, Eq64,
multiple equations, and actual component counts remain outside its scope.
See ../current_graded_method_costs/STANDARD_SUPPORT_FOURTH_POWER.md and AUDIT.md.
