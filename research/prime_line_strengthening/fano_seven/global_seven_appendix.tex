...
\[
 ...
 (z-1)(v-z+1)=0.                              \tag{G6}
\]
For reproducibility, \path{orbit7_generic.py} constructs $M$ by the
operations just specified, \path{orbit7_branches.py} performs (G4)--(G5),
and \path{orbit7_symmetry.py} checks each relabeling and projective
renormalization.  The identity file
\path{orbit7_identity_certificate.json.gz} contains $380$ nodes.
...
An independent verifier, \path{orbit7_certificate_independent.py},
