...
if __name__=='__main__':
 ap=argparse.ArgumentParser();ap.add_argument('--h',default='95');ap.add_argument('--output',required=True);ap.add_argument('--mixed',action='store_true');ap.add_argument('--source',default='Singer');ap.add_argument('--targets');ap.add_argument('--resume',action='store_true');ap.add_argument('--census');ap.add_argument('--source-class',type=int,default=0);ap.add_argument('--target-indices');ap.add_argument('--target-start',type=int,default=0);ap.add_argument('--target-stop',type=int,default=80);a=ap.parse_args()
 if a.census:
