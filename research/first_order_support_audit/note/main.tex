...
length with an explicit corrected margin, uniformly in multiplicity. An explicit high-rate support optimization proves a strict improvement
of a known sufficient curve at every rate above $8-3\sqrt6$. Two exact
