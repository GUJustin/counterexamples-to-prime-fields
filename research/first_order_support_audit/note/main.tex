...
draft's specified reconstruction formulas. These are not converses for
the current ePrint, which has improved quadratic and fourth-power bounds.
For full-coefficient monomial sources, these cost bounds hold at finite
length with an explicit corrected margin, uniformly in multiplicity. An explicit high-rate support optimization gives the sharp continuum
...
establish tightness of these current bounds. The current ePrint also
...
converse for the inverse-margin costs of the unchanged bounds. No independent referee or formal verification
...
lemma. An additional exact verifier checks 3743 arbitrary supports for
the rank estimates in Section~\ref{sec:gap-costs}, the narrow-cap obstruction,
and three positive-surplus supports for the parameter inequalities.
Another verifier checks 504 saturated-rank comparisons under degree-preserving
nonmonomial degeneration, including 196 strict rank drops. The finite-length cost transfer is
checked in 6750 reductions, including 1054 positive-surplus ratio
comparisons and a near-critical positive certificate at length one million.
These checks corroborate the formulas; the proofs establish the
quantified statements. The restored high-rate shape formula also passes 220 exact rational
polygon integrations and 4851 endpoint comparisons.
Scripts and reports accompany this note in
