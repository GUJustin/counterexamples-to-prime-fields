...
constant number of agreement coordinates of improvement. Within the unchanged
first-order interpolation and reconstruction bounds, optimizing monomial supports or translation-stable nonmonomial
jet spaces also cannot improve the cubic list-budget and
fifth-power MCA-budget dependence on the margin above this threshold.
