...
ePrint's full-coefficient monomial order ideals and either graded row or
column-only test, we prove necessary
...
uniformly in multiplicity; the row converse requires downward closure
in both jet coordinates, whereas the column converse only requires it in $Y_0$. An explicit high-rate support optimization gives the sharp continuum
...
separately proves the current powers necessary for coordinatewise monomial
order ideals with full derivative-weighted coefficient prefixes, using
either the graded row or column-only test; the latter also covers supports
downward only in $Y_0$. The result uses this note's stronger local-rank
