...
ePrint's standard capped supports and graded row test, we prove necessary
...
uniformly in multiplicity; the current graded converse has the narrower
standard-support scope. An explicit high-rate support optimization gives the sharp continuum
...
separately proves the current powers necessary for the standard capped
source and graded row test, under this note's stronger local-rank
