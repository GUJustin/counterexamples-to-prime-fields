...
over $\F_{p^4}$ with growing prime $p$. Superlinear
...
counts at exact rate $1/8$ and gap $1/16$ over $\F_{p^4}$,
with extension degree fixed independently of length
...
$d\ge b+7$, over the fixed-degree extensions $\F_{p^{2^b}}$,
including rate $2/9$ and gap $1/9$ over $\F_{p^4}$.
