...
A padding refinement (Theorem~\ref{fg:larger-gap-lines}) keeps
$n=\Theta(\log p)$ while increasing both the gap and the nearby-label
count to orders $1/\sqrt{\log p\,\log\log p}$ and
$p/\sqrt{\log p\,\log\log p}$, respectively.
