...
one, with no correlated agreement. An anchored lift and padding construction
...
nearby parameters tends to one, although no common agreement explanation
exists. Choosing the gap constant appropriately makes the proposed
...
at polylogarithmic length and gap $\Theta(1/\log p)$. Choosing its
constant appropriately makes the proposed fraction tend to zero.
