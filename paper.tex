...
For lists, integer-interval domains give
...
$N^{c+1}$. The missing ingredient is such a growing fixed-gap list;
full-length lists with $N=p-1$ cannot give superlinear scalar-label counts.
...
$\Omega_\varepsilon(n^{5/4-\varepsilon})$ nearby labels with no ordinary
...
\bibitem{heath-brown-sieves} D. R. Heath-Brown.
\emph{Lectures on sieves}. arXiv:math/0209360, 2002.
\url{https://arxiv.org/abs/math/0209360}.

\bibitem{tao-linear-sieve} T. Tao.
\emph{254A, Supplement 5: The linear sieve and Chen's theorem (optional)}.
January 29, 2015.
\url{https://terrytao.wordpress.com/2015/01/29/254a-supplement-5-the-linear-sieve-and-chens-theorem-optional/}.
