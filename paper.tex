...
over finite extensions of growing prime characteristic. Superlinear
...
counts at exact rate $1/8$ and gap $1/16$ over larger finite extensions,
whose degree can be bounded by $4n^2$
...
parameters to rate $b/d$ and gap $1/d$ for $b\in\{2,3,4\}$ and
$d\ge b+7$, including rate $2/9$ and gap $1/9$.
