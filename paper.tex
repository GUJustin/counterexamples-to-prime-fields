...
$648$ distinct certified exceptional challenges with agreement $51$,
while the two source agreements are at most $45$ and exactly $34$.
Its threshold is above first order and below Johnson. The refinement
uses the exact correction degree and removes collisions between the
constructed labels; the fixed-characteristic asymptotic regime is
already present in~\cite{binary-counterexamples}.
