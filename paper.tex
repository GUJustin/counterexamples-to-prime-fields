...
word misses the radius can tend to infinity. An anchored lift and padding construction
...
coordinate beyond the radius and no common agreement explanation exists.
A refinement increases this separation to a growing number of coordinates,
while the relative separation still tends to zero
(Corollary~\ref{fg:growing-far}). Choosing the gap constant appropriately makes the proposed
