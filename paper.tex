...
affine line. At logarithmic block length and shrinking gap,
any prescribed fraction below one of all field parameters can be nearby,
with no correlated agreement. An anchored lift and padding construction
...
$n$ in an exceptional-parameter bound. They do not establish that the
exceptional count must be superlinear in $n$ at one fixed positive gap
on short prime-field domains; that stronger question remains open.
