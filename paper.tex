...
grow (Corollary~\ref{fg:growing-far}). In that family, every affine
codeword graph contains only $o(n)$ of the nearby witnesses, regardless
of how those witnesses are chosen.
The relative outside separation can vanish arbitrarily slowly: for any
prescribed $\varepsilon(p)\to0$, a point can remain at least
$\varepsilon(p)\eta$ outside while the nearby fraction tends to one
(Corollary~\ref{fg:slow-separation}).
