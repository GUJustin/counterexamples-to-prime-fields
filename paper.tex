...
produce this behavior. A separate cubic deformation gives complete
...
The radius remains strictly below Elias. No pair of codewords explains
the line on the required common coordinate set.
...
The gap still shrinks as $\Theta(1/\log p)$, and the strongest relative
separation approaches the Elias boundary. These results do not
...
lower bounds? Lemma~\ref{pd:sampling} and Proposition~\ref{cw:sampling}
