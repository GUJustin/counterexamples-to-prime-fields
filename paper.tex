...
at a fixed positive agreement gap. At first order,
Appendix~\ref{app:actual-first-order} also bounds the total degrees
of the actual curve and surface components linearly in $D$.
