...
every coordinatewise monomial order ideal with full derivative-weighted
coefficient prefixes necessarily incurs inverse-margin powers two in the
squarefree list budget and four in the regular-family MCA budget,
under either the graded row test or the alternative column test.
For the column test, the result extends to all monomial supports downward
in the value variable, with the same full coefficient prefixes.
...
It does not cover arbitrary supports, nonmonomial interpolation spaces,
