...
At message dimension three, a translated grid gives
$\Omega(n^{4/3}\log n)$ singleton exceptional challenges with source
separation $\Theta(n^{1/6}/\log n)$ coordinates, in the regime of the
Dao--Kominers--Thaler bounds. This is a vanishing-rate result, not
