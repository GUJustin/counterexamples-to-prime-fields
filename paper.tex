...
a singleton, at an agreement threshold below Johnson and above the
first-order agreement curve. The common agreement misses that threshold by one coordinate.
...
fractional source separation vanish.
