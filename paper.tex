...
The construction is explicit over a cubic number field, and completeness
follows from saturated pairwise root counts and a seven-point
interpolation obstruction.
...
its standard derivative-capped, total-jet-degree-capped supports and
graded row test necessarily incur inverse-margin powers two in the
...
It does not cover arbitrary supports, the alternative column test,
...
\input{research/prime_line_strengthening/fano_seven/orbit7_appendix.tex}
