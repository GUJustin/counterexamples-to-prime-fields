...
A separate extension-field construction has an exact two-level spectrum;
its affine-witness companion asymptotically attains a universal
triple-count bound with constant one.
