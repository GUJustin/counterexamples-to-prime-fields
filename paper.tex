...
and evaluation domains. The construction follows by counting subsets
...
proves a list of at least $5{,}074{,}503{,}250{,}115$ codewords with
...
$L\ge5074503250115>2^{42}$ by Proposition~\ref{prop:polynomial-moment-weights}. Here $\eta=1/32$, so the choice
$c_1=c_2=1$ in \eqref{im:proposed-list} gives only $2^{32}$;
the improved ratio exceeds $1181$.
...
Reed--Solomon codes. It does not bound how many codewords can lie
...
there are $hB-2$ certified agreements. Distinct $F_A$ give distinct $P_A$;
