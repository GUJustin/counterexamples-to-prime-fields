...
A separate growing-characteristic result retains any fixed rate.
...
is far. This extension-field statement is separate from the
large-characteristic, above-first-order comparisons above.
